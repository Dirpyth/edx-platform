...
class CourseOutlineTest(UniqueCourseTest):
    ...
    def test_outline_when_pacing_changed_to_self_paced(self):
        """
        Scenario: Ensure that due dates for
